      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">Sma Negeri 2 Lamongan</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">Smadala</a>
          </div>
          <ul class="sidebar-menu">
              <li class="menu-header">Master Siswa</li>
                <li><a class="nav-link" href="{{url('/siswa')}}"><i class="fa fa-users" aria-hidden="true"></i>  <span>Data Siswa</span></a></li>
              ...
              <li><a class="nav-link" href="{{url('/scan')}}"><i class="fa fa-barcode" aria-hidden="true"></i><span>Scanner</span></a></li>
